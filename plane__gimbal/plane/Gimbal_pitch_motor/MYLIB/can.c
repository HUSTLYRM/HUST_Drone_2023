...
void vCan1Config(void)
{
	...
	/* standard id 11bits and left aligning(左对齐) */
	...
	can_filter.CAN_FilterIdLow =  0x203<<5 | CAN_ID_STD;
...
//	/* standard id 11bits and left aligning */
//	/* config as 32bits filter but id is still 11bits standard id */
//	can_filter.CAN_FilterIdHigh = 0x0;
//	can_filter.CAN_FilterIdLow =  0x0;
//	can_filter.CAN_FilterMaskIdHigh = 0x0;  
//	can_filter.CAN_FilterMaskIdLow = 0x0;
//	can_filter.CAN_FilterFIFOAssignment = 1;
//	can_filter.CAN_FilterActivation = ENABLE;
//	CAN_FilterInit(&can_filter);
...
can.CAN_Prescaler = 3;
	...
	can_filter.CAN_FilterMaskIdLow = 0 | CAN_ID_STD;
	can_filter.CAN_FilterFIFOAssignment = CAN_FIFO1;//1;
	can_filter.CAN_FilterActivation = ENABLE;
	CAN_FilterInit(&can_filter);
